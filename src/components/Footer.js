      ...
      <div className="container">
        ...
        <div className="footer-bottom flex justify-between items-center pt-10 flex-wrap gap-5">
          ...
          <div className="footer-bottom-links flex gap-6">
            <Link href="/info?tab=legal&doc=privacy" className="footer-bottom-link text-[12px] text-white/40 no-underline hover:text-white">Privacy Policy</Link>
            <Link href="/info?tab=legal&doc=terms" className="footer-bottom-link text-[12px] text-white/40 no-underline hover:text-white">Terms & Conditions</Link>
          </div>
        </div>
      </div>
    </footer>

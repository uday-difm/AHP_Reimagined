  ...
  return (
    <section id="events" className="community-section pt-16 pb-[100px] bg-gradient-to-br from-emerald-50/30 via-white to-teal-50/30 rounded-t-[40px] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        {/* Fixed 2-column grid layout so left side never shifts position */}
        <div className="community-grid grid grid-cols-1 lg:grid-cols-[1fr_1.1fr] gap-12 lg:gap-16 items-start max-w-6xl mx-auto">
          ...
          <div className="community-info flex flex-col items-start reveal-slide">
            ...
            <div className="grid grid-cols-4 gap-4 w-full max-w-md mb-8">
              {[
                ...
                { title: 'Wellness Talks', sub: 'Learn', icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m-9 9a9 9 0 019-9" /></svg> },
          ...
          {/* Right Side: Event Card Column */}
          <div className="community-featured reveal-scale relative z-10 w-full h-full flex flex-col">
            {event ? (
              /* Active Featured Event from Backend CRM */
              <div className="bg-white rounded-[32px] overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.06)] border border-slate-100 flex-1 flex flex-col justify-between">
                <div>
                  {/* Image Area */}
                  {event.imageUrl && (
              ...
              /* Upcoming Events Placeholder Banner (Maintains exact 2-column layout position when no event is published) */
              <div className="bg-gradient-to-br from-white via-teal-50/20 to-emerald-50/30 rounded-[32px] p-8 md:p-10 border border-teal-100/60 shadow-[0_20px_60px_rgba(0,0,0,0.04)] flex flex-col justify-between items-start h-full min-h-[380px]">
                <div>
                  <div className="w-12 h-12 rounded-2xl bg-[#0f7c85]/10 text-[#0f7c85] flex items-center justify-center mb-6">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                  </div>
                  <span className="text-[11px] font-bold tracking-[2px] text-[#0f7c85] uppercase mb-2 block">COMMUNITY EVENTS</span>
                  <h3 className="font-heading font-extrabold text-2xl text-slate-800 leading-tight mb-3">Upcoming Community Events</h3>
                  <p className="text-sm font-medium text-slate-600 leading-relaxed max-w-md">
                    We host group nature walks, online yoga sessions, and wellness seminars. New events are published regularly by our community team!
                  </p>
                </div>
                <div className="pt-6 border-t border-slate-100 w-full flex items-center justify-between">
                  <span className="text-xs font-semibold text-slate-500">Stay tuned for new dates</span>
                  <Button href="/events" variant="outline" className="!rounded-xl !px-5 !py-2.5 !text-xs !font-bold !border-[#0f7c85]/30 !text-[#0f7c85] hover:!bg-[#0f7c85]/5 transition-all">
                    Explore Events →
                  </Button>
                </div>
              </div>

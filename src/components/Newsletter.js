    ...
    <section id="contact" className="cta-section py-[80px] bg-white relative overflow-hidden">
      ...
      <div className="container relative z-10">
        <div className="max-w-3xl mx-auto text-center reveal-slide">
          ...
          <span className="text-accent text-[11px] font-bold uppercase tracking-[2.5px] block mb-4">STAY CONNECTED</span>
          <h2 className="cta-title font-heading font-extrabold text-[36px] md:text-[52px] text-primary tracking-[-1.5px] leading-[1.1] mb-5">
            Subscribe to our newsletter
          </h2>
          <p className="cta-subtitle text-[15px] md:text-[16px] text-secondary leading-relaxed mb-10 max-w-xl mx-auto">
          ...
          <form className="flex flex-col sm:flex-row gap-3 w-full max-w-[520px] mx-auto" onSubmit={handleNewsSubmit}>
            <input
              ...
              required
              className="flex-grow bg-white border border-slate-200 rounded-full px-6 py-4 text-[14px] outline-none text-primary focus:border-accent focus:shadow-[0_0_0_4px_rgba(31,185,251,0.1)] transition-all shadow-sm"
            />
          ...
          <p className="text-slate-400 text-[12px] mt-5 font-medium">

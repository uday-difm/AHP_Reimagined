...
export default function Button({
  ...
  const baseClasses = 'inline-flex items-center justify-center font-heading font-bold text-[14px] md:text-[15px] py-3.5 px-8 rounded-full transition-all duration-300 select-none no-underline cursor-pointer active:scale-[0.98] disabled:opacity-50 disabled:pointer-events-none';

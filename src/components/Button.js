...
export default function Button({
  ...
  const baseClasses = 'btn inline-flex items-center justify-center font-heading font-medium text-sm md:text-base px-8 py-4 rounded-full transition-all duration-300 select-none no-underline cursor-pointer active:scale-[0.98] disabled:opacity-50 disabled:pointer-events-none';

...
// PUT /api/dashboard/quizzes/[id] — update a question
export async function PUT(req, { params }) {
  ...
  try {
    ...
    console.error("PUT /api/dashboard/quizzes/[id] error:", err);
    return NextResponse.json({ error: "Internal Server Error" }, { status: 500 });
  }
}

// DELETE /api/dashboard/quizzes/[id] — delete a question
export async function DELETE(req, { params }) {
  ...
  try {
    ...
    console.error("DELETE /api/dashboard/quizzes/[id] error:", err);
    return NextResponse.json({ error: "Internal Server Error" }, { status: 500 });
  }
}
